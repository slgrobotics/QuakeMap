...
namespace LibSys
{
	...
	public class ThreadPool2
	{
		...
		static Stack _waitingCallbacks;
		/// <summary>
		...
		public ThreadPool2()
		{
			...
			for(int i=0; i<_maxWorkerThreads; i++)
			{
				...
				newThread.CurrentCulture = Thread.CurrentThread.CurrentCulture; //new CultureInfo("en-US", false);
				newThread.CurrentUICulture = Thread.CurrentThread.CurrentUICulture; //new CultureInfo("en-US", false);
				_workerThreads.Add(newThread);

				// Configure the new thread and start it
				newThread.Name = "ThreadPool2-" + i.ToString();
		...
		public static void QueueUserWorkItem(WaitCallback callback, object state)
		{
			...
			lock(_waitingCallbacks.SyncRoot) { _waitingCallbacks.Push(waiting); }
